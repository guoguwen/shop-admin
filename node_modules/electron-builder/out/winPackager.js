...
class WinPackager extends (_platformPackager || _load_platformPackager()).PlatformPackager {
    ...
    signAndEditResources(file, arch, outDir, internalName) {
        var _this4 = this;
    ...
    signApp(packContext) {
        ...
        return this.signAndEditResources(_path.join(packContext.appOutDir, exeFileName), packContext.arch, packContext.outDir, _path.basename(exeFileName, ".exe"));
    }
}
