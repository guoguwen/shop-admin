...
class BintrayClient {
    ...
    bintrayRequest(path, auth) {
        ...
        return this.httpExecutor.request((0, (_httpExecutor || _load_httpExecutor()).configureRequestOptions)({ hostname: "api.bintray.com", path, headers: this.requestHeaders || undefined }, auth, method), cancellationToken, data).then(it => JSON.parse(it));
    }
    getVersion(version) {
