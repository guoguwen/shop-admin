    ...
    <div class="content-main">
      <div class="form-table-box">
        <el-form ref="infoForm" :rules="infoRules" :model="infoForm" label-width="120px">
            ...
            <el-row>
              <el-col :span=12>
                <div class="grid-content">
                  <el-button plain @click="sigleGood('sigle')">单品</el-button><el-button @click="sigleGood('double')" plain>多规格</el-button>  
                </div>
              </el-col>    
            </el-row>
          </el-form-item>
          ...
          <!-- 规格明细 单品 -->
          <el-form-item v-show="choose">
            <el-table :data="sigleData" border style="width: 100%">
              <el-table-column prop="s_price" label="单买价">
                <template scope="scope">
                  <el-input v-model="scope.row.s_price"></el-input>  
                </template>
              </el-table-column>
              <el-table-column v-show="is_pintuan" prop="tuan_price"  label="团购价">
                <template scope="scope">
                  <el-input v-show="is_pintuan" v-model="scope.row.tuan_price"></el-input>  
                </template>
              </el-table-column>
          ...
          <el-form-item label='首页主图' prop="list_pic_url">
            <el-upload action="https://dh.sty.sztcmdiet.com/admin/upload/upimg" name="img" :headers="uploaderHeader" list-type="picture-card" :on-preview="handlePictureCardPreview"
  ...
  export default {
    data() {
      return {
        ...
        bands:[],
        tabcol:[],
        sigleData:[{s_price:0,tuan_price:0,goods_number:0}],
    ...
    methods: {
      ...
      savePrice(){
        ...
        console.log(this.e_num+''+this.tableData);
      },
      addSku() {
        if(this.spec.fi[2]){
          this.spec.fi[3]=true;
      ...
      onSubmitInfo() {
        ...
        if(this.choose){
          data = {
            ...
            goods_number:this.sigleData[0].goods_number,
