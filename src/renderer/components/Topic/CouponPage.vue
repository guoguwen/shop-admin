	...
	<div class="content-page">
		<div class="content-nav">
			<el-breadcrumb class="breadcrumb" separator="/">
				...
				<el-breadcrumb-item>优惠券信息</el-breadcrumb-item>
			</el-breadcrumb>
			<div class="operation-nav">
				<router-link to="/dashboard/operate/coupon/add">
					<el-button type="primary" icon="plus">创建优惠券</el-button>
				</router-link>
			</div>
		</div>
		<div class="content-main">
			<div class="form-table-box">
				<el-table :data="tableData" style="width: 100%" border stripe>
					...
					<el-table-column prop="is_show" label="金额" width="100">
					</el-table-column>
					<el-table-column prop="sort_order" label="领取限制" width="80">
					</el-table-column>
					<el-table-column prop="sort_order" label="使用/领取" width="80">
					</el-table-column>
					<el-table-column prop="sort_order" label="创建时间" width="80">
					</el-table-column>
